...
namespace bus_reservation.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public IActionResult Details(int? id)
        {
            if (id == null)
            {
                return NotFound(); // Handle the case when id is null
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(Employee employee, IFormFile file, string oldImage, string password, string oldPassword)
        {
